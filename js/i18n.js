...
const translations = {
  es: {
    ...
    fase_ascenso_semifinal_ida: 'Fase Ascenso - Semifinal (Ida)',
    fase_ascenso_semifinal_vuelta: 'Fase Ascenso - Semifinal (Vuelta)',
    fase_ascenso_final_ida: 'Fase Ascenso - Final (Ida)',
    fase_ascenso_final_vuelta: 'Fase Ascenso - Final (Vuelta)',
  ...
  en: {
    ...
    copa_ronda_final: 'Final',
    // Promotion play-offs (keys generated by app.js line 1846)
    fase_ascenso_semifinal_ida: 'Play-offs - Semi-final (1st Leg)',
    fase_ascenso_semifinal_vuelta: 'Play-offs - Semi-final (2nd Leg)',
    fase_ascenso_final_ida: 'Play-offs - Final (1st Leg)',
    fase_ascenso_final_vuelta: 'Play-offs - Final (2nd Leg)',
