...
const translations = {
  ...
  en: {
    ...
    'copa_ronda_fase_ascenso_-_semifinal_ida':
      'Play-offs - Semi-final (1st Leg)',
    'copa_ronda_fase_ascenso_-_semifinal_vuelta':
      'Play-offs - Semi-final (2nd Leg)',
    'copa_ronda_fase_ascenso_-_final_ida': 'Play-offs - Final (1st Leg)',
    'copa_ronda_fase_ascenso_-_final_vuelta': 'Play-offs - Final (2nd Leg)',
    // Alias without hyphens (for other contexts)
    comp_copa_ronda_fase_ascenso_semifinal_ida:
      'Play-offs - Semi-final (1st Leg)',
    comp_copa_ronda_fase_ascenso_semifinal_vuelta:
      'Play-offs - Semi-final (2nd Leg)',
    comp_copa_ronda_fase_ascenso_final_ida: 'Play-offs - Final (1st Leg)',
    comp_copa_ronda_fase_ascenso_final_vuelta: 'Play-offs - Final (2nd Leg)',
