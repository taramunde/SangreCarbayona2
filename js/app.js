...
const App = {
    ...
    renderSeasonSelector: function() {
        ...
        CLUB_DATA.temporadasDisponibles.forEach(temp => {
            ...
            html += `
                <button class="season-tab ${activeClass}" data-season="${temp.id}">
                    ${temp.nombre} ${currentBadge}
                </button>
            `;
        });
        ...
        temporada.jugadores.slice(0, 8).forEach(jugador => {
            html += `
                <div class="player-card" data-position="${posicionesMap[jugador.posicion] || 'all'}">
                    <a href="ficha-jugador.html?id=${jugador.id}&season=${CLUB_DATA.temporadaActual}">
        ...
        container.innerHTML = `
            ...
            <div class="player-info-container">
                ...
                <div class="player-quick-stats">
                    ...
                    <div class="quick-stat"><span class="quick-stat-value">${jugador.altura}m</span><span class="quick-stat-label">Altura</span></div>
                    <div class="quick-stat"><span class="quick-stat-value">${jugador.peso}kg</span><span class="quick-stat-label">Peso</span></div>
                    <div class="quick-stat"><span class="quick-stat-value">${jugador.pie.charAt(0)}</span><span class="quick-stat-label">Pie</span></div>
                </div>
