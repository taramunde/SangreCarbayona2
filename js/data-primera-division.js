    ...
    jornadas: [
      {
        ...
        partidos: [
          ...
          },
          {
            ...
            estado: 'finalizado',
            goleadores: [
              { jugador: 'Nico Williams', minuto: "36'", equipo: 'local', tipo: 'penalti' },
          ...
          },
          {
            ...
            golesVisitante: 0,
            estado: 'finalizado',
            goleadores: [{ jugador: 'Mbappé', minuto: "51'", equipo: 'local', tipo: 'penalti' }],
          },
        ],
      },
      {
        ...
        partidos: [
          ...
          },
          {
            ...
            golesVisitante: 0,
            estado: 'finalizado',
            goleadores: [{ jugador: 'Budimir', minuto: "9'", equipo: 'local' }],
          },
          {
            local: 'Real Sociedad',
            ...
            estado: 'finalizado',
            goleadores: [
              { jugador: 'Pere Milla', minuto: "10'", equipo: 'visitante' },
              { jugador: 'Javi Puado', minuto: "45'", equipo: 'visitante', tipo: 'penalti' },
              { jugador: 'Barrenetxea', minuto: "61'", equipo: 'local' },
              { jugador: 'Oskarsson', minuto: "69'", equipo: 'local' },
            ],
          },
          {
            local: 'Villarreal C.F.',
            ...
            estado: 'finalizado',
            goleadores: [
              { jugador: 'Pépé', minuto: "7'", equipo: 'local' },
              { jugador: 'Buchanan', minuto: "16'", equipo: 'local' },
              { jugador: 'Rafa Marín', minuto: "25'", equipo: 'local' },
              { jugador: 'Buchanan', minuto: "28'", equipo: 'local' },
              { jugador: 'Buchanan', minuto: "64'", equipo: 'local' },
            ],
          },
          {
            local: 'Real Oviedo',
            ...
            estado: 'finalizado',
            goleadores: [
              { jugador: 'Mbappé', minuto: "37'", equipo: 'visitante' },
              { jugador: 'Mbappé', minuto: "83'", equipo: 'visitante' },
              { jugador: 'Vinicius Jr.', minuto: "90'", equipo: 'visitante' },
            ],
          },
          {
            local: 'Athletic Club',
            ...
            golesVisitante: 0,
            estado: 'finalizado',
            goleadores: [{ jugador: 'Sancet', minuto: "66'", equipo: 'local' }],
          },
          {
            local: 'Sevilla F.C.',
            visitante: 'Getafe C.F.',
            ...
            estado: 'finalizado',
            goleadores: [
              { jugador: 'Adrián Liso', minuto: "15'", equipo: 'visitante' },
              { jugador: 'Iglesias', minuto: "45'", equipo: 'local', tipo: 'propia' },
              { jugador: 'Adrián Liso', minuto: "51'", equipo: 'visitante' },
            ],
          },
        ],
      },
        ...
        partidos: [
          {
            ...
            estado: 'finalizado',
            goleadores: [
              { jugador: 'Rafa Mir', minuto: "46'", equipo: 'local' },
              { jugador: 'Mendoza', minuto: "51'", equipo: 'local' },
            ],
          },
          {
            local: 'Valencia C.F.',
            ...
            estado: 'finalizado',
            goleadores: [
              { jugador: 'Diakhaby', minuto: "30'", equipo: 'local' },
              { jugador: 'Danjuma', minuto: "54'", equipo: 'local' },
              { jugador: 'Hugo Duro', minuto: "90'", equipo: 'local' },
            ],
          },
          {
            local: 'Deportivo Alavés',
            ...
            estado: 'finalizado',
            goleadores: [
              { jugador: 'Simeone', minuto: "7'", equipo: 'visitante' },
              { jugador: 'Carlos Vicente', minuto: "14'", equipo: 'local', tipo: 'penalti' },
            ],
          },
          {
            local: 'Real Oviedo',
            ...
            golesVisitante: 0,
            estado: 'finalizado',
            goleadores: [{ jugador: 'Dendoncker', minuto: "40'", equipo: 'local' }],
          },
          {
            local: 'Girona F.C.',
            visitante: 'Sevilla F.C.',
            ...
            estado: 'finalizado',
            goleadores: [
              { jugador: 'Alfon', minuto: "30'", equipo: 'visitante' },
              { jugador: 'Isaac Romero', minuto: "55'", equipo: 'visitante' },
            ],
          },
          {
            local: 'Real Madrid',
            ...
            estado: 'finalizado',
            goleadores: [
              { jugador: 'Muriqi', minuto: "18'", equipo: 'visitante' },
              { jugador: 'Arda Güler', minuto: "37'", equipo: 'local' },
              { jugador: 'Vinicius Jr.', minuto: "38'", equipo: 'local' },
            ],
          },
          {
            local: 'R.C. Celta de Vigo',
            ...
            estado: 'finalizado',
            goleadores: [
              { jugador: 'Pépé', minuto: "53'", equipo: 'visitante' },
              { jugador: 'Borja Iglesias', minuto: "90'", equipo: 'local' },
            ],
          },
        ],
      },
