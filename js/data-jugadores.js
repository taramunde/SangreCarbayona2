...
CLUB_DATA.jugadoresMaestro = {
  ...
  'orlando-quintana-garcia': {
    nombre: 'Orlando',
    apellidos: 'Quintana García',
    nombreCompleto: 'Orlando Quintana García',
    ...
    imagen: 'https://i.ibb.co/MyvJdTvK/Orlando-Quintana-PNG.webp',
  },

  'pol-freixanet-viejo': {
    nombre: 'Pol',
    apellidos: 'Freixanet Viejo',
    nombreCompleto: 'Pol Freixanet Viejo',
    apodo: 'Pol Freixanet',
    posicion: 'Portero',
    posicionCorta: 'PO',
    altura: 1.93,
    nacionalidad: ['Española'],
    lugarNacimiento: 'Manresa',
    provinciaNacimiento: 'Barcelona',
    fechaNacimiento: '1991-08-22',
    imagen: 'https://i.ibb.co/5xr2Bq0P/Pol-Freixanet-PNG.webp',
  },

  'marcos-de-castro-cogle': {
    nombre: 'Marcos',
    apellidos: 'de Castro Cogle',
    nombreCompleto: 'Marcos de Castro Cogle',
    apodo: 'Marcos',
    posicion: 'Portero',
    posicionCorta: 'PO',
    altura: '-',
    ...
    imagen: 'https://i.ibb.co/kgJMBCF0/Marcos-PNG.webp',
  },

  'daniel-barrio-alvarez': {
    nombre: 'Daniel',
    apellidos: 'Barrio Álvarez',
    nombreCompleto: 'Daniel Barrio Álvarez',
    apodo: 'Dani Barrio',
    posicion: 'Portero',
    posicionCorta: 'PO',
    altura: 1.9,
    ...
    imagen: 'https://i.ibb.co/3mg2TX3c/Dani-Barrio-PNG.webp',
  },

  'mario-fernandez-ruyales': {
    nombre: 'Mario',
    apellidos: 'Fernández Ruyales',
    nombreCompleto: 'Mario Fernández Ruyales',
    apodo: 'Mario Ruyales',
    posicion: 'Portero',
    posicionCorta: 'PO',
    altura: 1.87,
    ...
    fechaNacimiento: '1984-09-25',
    imagen: 'https://i.ibb.co/MyVTkDXX/Mario-Ruyales-PNG.webp',
  },

  'francisco-javier-lledo-llano': {
    nombre: 'Francisco Javier',
    apellidos: 'Lledó Llano',
    nombreCompleto: 'Francisco Javier Lledó Llano',
    apodo: 'Lledó',
    posicion: 'Portero',
    posicionCorta: 'PO',
    altura: 1.85,
    nacionalidad: ['Española'],
    lugarNacimiento: 'Coria del Río',
    provinciaNacimiento: 'Sevilla',
    fechaNacimiento: '1979-07-11',
    imagen: 'https://i.ibb.co/4vjwybZ/Lled-PNG.webp',
  },

  'adrian-torre-gonzalez': {
    nombre: 'Adrián',
    apellidos: 'Torre González',
    nombreCompleto: 'Adrián Torre González',
    apodo: 'Adrián',
    posicion: 'Portero',
    posicionCorta: 'PO',
    altura: 1.84,
  ...
  'jose-antonio-pardo-lucas': {
    nombre: 'José Antonio',
    apellidos: 'Pardo Lucas',
    nombreCompleto: 'José Antonio Pardo Lucas',
    apodo: 'Pardo',
    posicion: 'Defensa',
    posicionCorta: 'DC',
    altura: 1.88,
    nacionalidad: ['Española'],
    lugarNacimiento: 'Puzol',
    provinciaNacimiento: 'Valencia',
    fechaNacimiento: '1988-04-21',
    imagen: 'https://i.ibb.co/dsBMHJ22/Pardo-PNG.webp',
  },

  'alvaro-garcia-cuello': {
    nombre: 'Álvaro',
    apellidos: 'García Cuello',
    nombreCompleto: 'Álvaro García Cuello',
    apodo: 'Álvaro Cuello',
    posicion: 'Defensa',
    posicionCorta: 'DC',
    altura: 1.83,
    ...
    imagen: 'https://i.ibb.co/WN4bjXK3/lvaro-Cuello-PNG.webp',
  },

  'david-alba-garcia-baquero': {
    nombre: 'David',
    apellidos: 'Alba García-Baquero',
    nombreCompleto: 'David Alba García-Baquero',
    apodo: 'Alba',
    posicion: 'Defensa',
    posicionCorta: 'LD',
    altura: 1.78,
    ...
    provinciaNacimiento: 'Madrid',
    fechaNacimiento: '1985-04-06',
    imagen: 'https://i.ibb.co/hRfNX9ty/Alba-PNG.webp',
  },

  'sergio-rodriguez-cidoncha': {
    nombre: 'Sergio',
    apellidos: 'Rodríguez Cidoncha',
    nombreCompleto: 'Sergio Rodríguez Cidoncha',
    ...
    provinciaNacimiento: 'Badajoz',
    fechaNacimiento: '1989-10-05',
    imagen: 'https://i.ibb.co/5xf086bb/Sergio-Rodr-guez-PNG.webp',
  },

  'francisco-javier-hernandez-garcia': {
    nombre: 'Francisco Javier',
    apellidos: 'Hernández García',
    nombreCompleto: 'Francisco Javier Hernández García',
    apodo: 'Javi Hernández',
    posicion: 'Defensa',
    posicionCorta: 'DC',
    altura: 1.89,
    nacionalidad: ['Española'],
    lugarNacimiento: 'Almansa',
    provinciaNacimiento: 'Albacete',
    fechaNacimiento: '1983-01-20',
    imagen: 'https://i.ibb.co/jvTP6yDn/Javi-Hern-ndez-La-Mancha-PNG.webp',
  },

  'sergio-diaz-castilla': {
    nombre: 'Sergio',
    apellidos: 'Díaz Castilla',
    nombreCompleto: 'Sergio Díaz Castilla',
    apodo: 'Sergio Díaz',
    posicion: 'Defensa',
    posicionCorta: 'LI',
    altura: 1.78,
    ...
    fechaNacimiento: '1991-07-02',
    imagen: 'https://i.ibb.co/5x9XjLgZ/Sergio-D-az-PNG.webp',
  },

  'roberto-villa-gonzalez': {
    nombre: 'Roberto',
    apellidos: 'Villa González',
    nombreCompleto: 'Roberto Villa González',
    apodo: 'Chapi',
    posicion: 'Defensa',
    posicionCorta: 'LD',
    altura: '-',
    ...
    imagen: 'https://i.ibb.co/MyMpFTwv/Chapi-PNG.webp',
  },

  'martin-maximiliano-mantovani': {
    nombre: 'Martín Maximiliano',
    apellidos: 'Mantovani',
    nombreCompleto: 'Martín Maximiliano Mantovani',
    apodo: 'Mantovani',
    posicion: 'Defensa',
    posicionCorta: 'DC',
    altura: 1.83,
    ...
    provinciaNacimiento: 'Buenos Aires',
    fechaNacimiento: '1984-07-07',
    imagen: 'https://i.ibb.co/ZqdHS4d/Mantovani-PNG.webp',
  },

  'javier-cantero-de-la-puente': {
    nombre: 'Javier',
    apellidos: 'Cantero de La Puente',
    nombreCompleto: 'Javier Cantero de La Puente',
    apodo: 'Javi Cantero',
    posicion: 'Defensa',
    posicionCorta: 'LI',
    altura: 1.7,
    nacionalidad: ['Española'],
    lugarNacimiento: 'Granada',
    provinciaNacimiento: 'Granada',
    fechaNacimiento: '1988-01-22',
    imagen: 'https://i.ibb.co/ZpR18cKw/Javi-Cantero-PNG.webp',
    seleccion: {
      pais: 'España',
      bandera: 'https://flagcdn.com/16x12/es.webp',
      datos: [
  ...
  'pedro-jesus-lopez-baquero': {
    nombre: 'Pedro Jesús ',
    apellidos: 'López Baquero',
    nombreCompleto: 'Pedro Jesús  López Baquero',
    apodo: 'Baquero',
    posicion: 'Defensa',
    posicionCorta: 'DC',
    altura: 1.83,
    nacionalidad: ['Española'],
    lugarNacimiento: 'Huelva',
    provinciaNacimiento: 'Huelva',
    fechaNacimiento: '1980-10-02',
    imagen: 'https://i.ibb.co/rR4304C6/Baquero-PNG.webp',
  },

  'lucien-fridolin-owona-ndong': {
    nombre: 'Lucien Fridolin',
    apellidos: 'Owona-Ndong',
    nombreCompleto: 'Lucien Fridolin Owona-Ndong',
    apodo: 'Owona',
    posicion: 'Defensa',
    posicionCorta: 'DC',
    altura: 1.88,
    ...
    fechaNacimiento: '1990-08-09',
    imagen: 'https://i.ibb.co/jv3SWhC5/Owona-PNG.webp',
    seleccion: {
      pais: 'Camerún',
  ...
  'efren-urrutia-curto': {
    nombre: 'Efrén',
    apellidos: 'Urrutia Curto',
    nombreCompleto: 'Efrén Urrutia Curto',
    apodo: 'Efrén',
    posicion: 'Defensa',
    posicionCorta: 'DC',
    altura: 1.83,
    ...
    imagen: 'https://i.ibb.co/chsgzwRN/Efr-n-PNG.webp',
  },

  'adrian-trabanco-ordiales': {
    nombre: 'Adrián',
    apellidos: 'Trabanco Ordiales',
    nombreCompleto: 'Adrián Trabanco Ordiales',
    apodo: 'Trabanco',
    posicion: 'Defensa',
    posicionCorta: 'DC',
    altura: 1.85,
    ...
    imagen: 'https://i.ibb.co/9mRBfB0V/Trabanco-PNG.webp',
  },

  'ivan-menendez-candela': {
    nombre: 'Iván',
    apellidos: 'Menéndez Candela',
    nombreCompleto: 'Iván Menéndez Candela',
    apodo: 'Candela',
    posicion: 'Defensa',
    posicionCorta: 'LI',
    altura: 1.8,
    ...
    lugarNacimiento: 'Avilés',
    provinciaNacimiento: 'Asturias',
    fechaNacimiento: '1978-09-13',
    imagen: 'https://i.ibb.co/3mDDpfvX/Candela-PNG.webp',
  },

  'juan-manuel-marrero-monzon': {
    nombre: 'Juan Manuel',
    apellidos: 'Marrero Monzón',
    nombreCompleto: 'Juan Manuel Marrero Monzón',
    apodo: 'Juanma',
    posicion: 'Defensa',
    posicionCorta: 'DC',
    altura: 1.85,
    ...
    imagen: 'https://i.ibb.co/r2wKMLFw/Juanma-PNG.webp',
  },

  'cesar-negredo-sanchez': {
    nombre: 'César',
    apellidos: 'Negredo Sánchez',
    nombreCompleto: 'César Negredo Sánchez',
    apodo: 'César Negredo',
    posicion: 'Defensa',
    posicionCorta: 'DC',
    altura: 1.85,
  ...
  'jorge-eugenio-rodriguez-alvarez': {
    ...
    nombreCompleto: 'Jorge Eugenio Rodríguez Álvarez',
    ...
    imagen: 'https://i.ibb.co/7HHGdZg/Jorge-Rodr-guez-PNG.webp',
  },

  'juan-pablo-de-miguel-bravo': {
    nombre: 'Juan Pablo',
    apellidos: 'de Miguel Bravo',
    nombreCompleto: 'Juan Pablo de Miguel Bravo',
    apodo: 'Juanpa',
    posicion: 'Defensa',
    posicionCorta: 'LD',
    altura: 1.79,
    ...
    provinciaNacimiento: 'Segovia',
    fechaNacimiento: '1978-09-28',
    imagen: 'https://i.ibb.co/CLpnVpb/Juanpa-PNG.webp',
  },

  'sergio-gonzalez-quintans': {
    nombre: 'Sergio',
    apellidos: 'González Quintans',
    nombreCompleto: 'Sergio González Quintans',
    apodo: 'Catú',
    posicion: 'Defensa',
    posicionCorta: 'DC',
    altura: 1.79,
    ...
    lugarNacimiento: 'Santiago de Compostela',
    provinciaNacimiento: 'La Coruña',
    fechaNacimiento: '1990-07-06',
    imagen: 'https://i.ibb.co/1GdzB79J/Cat-PNG.webp',
  },

  'joaquin-pena-alonso': {
    nombre: 'Joaquín',
    apellidos: 'Peña Alonso',
    nombreCompleto: 'Joaquín Peña Alonso',
    apodo: 'Joaquín Peña',
    posicion: 'Defensa',
    posicionCorta: 'DC',
    altura: 1.86,
  ...
  'lucas-torro-marset': {
    ...
    imagen: 'https://i.ibb.co/s9fCcXLr/Lucas-Torr-PNG.webp',
    seleccion: {
      pais: 'España',
      bandera: 'https://flagcdn.com/16x12/es.webp',
      datos: [
  ...
  'eduardo-bedia-pelaez': {
    ...
    imagen: 'https://i.ibb.co/8n0jf2qC/Edu-Bedia-PNG.webp',
    seleccion: {
      pais: 'España',
      bandera: 'https://flagcdn.com/16x12/es.webp',
      datos: [
  ...
  'salvador-gonzalez-rivas': {
    nombre: 'Salvador',
    apellidos: 'González Rivas',
    nombreCompleto: 'Salvador González Rivas',
    apodo: 'Salva Rivas',
    posicion: 'Centrocampista',
    posicionCorta: 'MC',
    altura: 1.83,
    ...
    imagen: 'https://i.ibb.co/mfyR8V0/Salva-Rivas-PNG.webp',
    seleccion: {
      pais: 'España',
      bandera: 'https://flagcdn.com/16x12/es.webp',
      datos: [
  ...
  'ivan-rubio-caudin': {
    nombre: 'Iván',
    apellidos: 'Rubio Caudín',
    nombreCompleto: 'Iván Rubio Caudín',
    apodo: 'Iván Rubio',
    posicion: 'Centrocampista',
    posicionCorta: 'MC',
    altura: 1.83,
    ...
    fechaNacimiento: '1991-03-01',
    imagen: 'https://i.ibb.co/0y7w3510/Iv-n-Rubio-PNG.webp',
    seleccion: {
      pais: 'España',
      bandera: 'https://flagcdn.com/16x12/es.webp',
      datos: [
  ...
  'hector-simon-escudero': {
    nombre: 'Héctor',
    apellidos: 'Simón Escudero',
    nombreCompleto: 'Héctor Simón Escudero',
    apodo: 'Héctor Simón',
    posicion: 'Centrocampista',
    posicionCorta: 'MC',
    altura: 1.68,
    nacionalidad: ['Española'],
    lugarNacimiento: 'Llansá',
    provinciaNacimiento: 'Gerona',
    fechaNacimiento: '1984-03-13',
    imagen: 'https://i.ibb.co/cKT6bh9g/H-ctor-Sim-n-PNG.webp',
    seleccion: {
      pais: 'España',
      bandera: 'https://flagcdn.com/16x12/es.webp',
      datos: [
  ...
  'belarmino-neila-garcia': {
    nombre: 'Belarmino',
    apellidos: 'Neila García',
    nombreCompleto: 'Belarmino Neila García',
    apodo: 'Belar',
    posicion: 'Centrocampista',
    posicionCorta: 'MCO',
    altura: '-',
    ...
    imagen: 'https://i.ibb.co/xq4sc74m/Belar-PNG.webp',
  },

  'pablo-coutado-gonzalez': {
    nombre: 'Pablo',
    apellidos: 'Coutado González',
    nombreCompleto: 'Pablo Coutado González',
    apodo: 'Coutado',
    posicion: 'Centrocampista',
    posicionCorta: 'MCO',
    altura: 1.75,
    ...
    imagen: 'https://i.ibb.co/w36fbzB/Coutado-PNG.webp',
  },

  'jordi-martinez-viejo': {
    nombre: 'Jordi',
    apellidos: 'Martínez Viejo',
    nombreCompleto: 'Jordi Martínez Viejo',
    apodo: 'Jordi',
    posicion: 'Centrocampista',
    posicionCorta: 'MCO',
    altura: '-',
    nacionalidad: ['Venezolana', 'Española'],
    lugarNacimiento: 'Anaco',
    provinciaNacimiento: 'Anzoátegui',
    fechaNacimiento: '1995-04-28',
    imagen: 'https://i.ibb.co/cSPf0vMW/Jordi-PNG.webp',
  },

  'alain-arroyo-martinez-de-la-cuadra': {
    nombre: 'Alain',
    apellidos: 'Arroyo Martínez de la Cuadra',
    nombreCompleto: 'Alain Arroyo Martínez de la Cuadra',
    apodo: 'Alain',
    posicion: 'Delantero',
    posicionCorta: 'DL',
    altura: 1.71,
    ...
    imagen: 'https://i.ibb.co/jcBnNB5/Alain-PNG.webp',
  },

  'aitor-sanz-martin': {
    nombre: 'Aitor',
    apellidos: 'Sanz Martín',
    nombreCompleto: 'Aitor Sanz Martín',
    apodo: 'Aitor Sanz',
    posicion: 'Centrocampista',
    posicionCorta: 'MC',
    altura: 1.81,
    ...
    imagen: 'https://i.ibb.co/zTmxMtL8/Aitor-Sanz-PNG.webp',
  },

  'iker-alegre-sancho': {
    nombre: 'Iker',
    apellidos: 'Alegre Sancho',
    nombreCompleto: 'Iker Alegre Sancho',
    apodo: 'Iker Alegre',
    posicion: 'Centrocampista',
    posicionCorta: 'MC',
    altura: 1.76,
    ...
    lugarNacimiento: 'Gijón',
    provinciaNacimiento: 'Asturias',
    fechaNacimiento: '1985-10-29',
    imagen: 'https://i.ibb.co/hrD3byV/Iker-Alegre-PNG.webp',
  },

  'pascual-puente-aller': {
    nombre: 'Pascual',
    apellidos: 'Puente Aller',
    nombreCompleto: 'Pascual Puente Aller',
    apodo: 'Pascual',
    posicion: 'Centrocampista',
    posicionCorta: 'MC',
    altura: 1.77,
    ...
    imagen: 'https://i.ibb.co/kg6NnTXL/Pascual-PNG.webp',
  },

  'francisco-javier-casares-garcia': {
    nombre: 'Francisco Javier',
    apellidos: 'Casares García',
    nombreCompleto: 'Francisco Javier Casares García',
    apodo: 'Casares',
    posicion: 'Centrocampista',
    posicionCorta: 'MCO',
    altura: 1.73,
    ...
    imagen: 'https://i.ibb.co/dw1t6dRb/Casares-PNG.webp',
  },

  'xavier-more-roca': {
    nombre: 'Xavier',
    apellidos: 'Moré Roca',
    nombreCompleto: 'Xavier Moré Roca',
    apodo: 'Xavi Moré',
    posicion: 'Centrocampista',
    posicionCorta: 'MC',
    altura: 1.8,
    nacionalidad: ['Española'],
    lugarNacimiento: 'La Ametlla',
    provinciaNacimiento: 'Barcelona',
    fechaNacimiento: '1982-06-07',
    imagen: 'https://i.ibb.co/KpkFftLJ/Xavi-Mor-PNG.webp',
  },

  'galder-cerrajeria-lopez': {
    nombre: 'Galder',
    apellidos: 'Cerrajería López',
    nombreCompleto: 'Galder Cerrajería López',
    apodo: 'Cerrajería',
    posicion: 'Centrocampista',
    posicionCorta: 'MC',
    altura: 1.85,
    nacionalidad: ['Española'],
    lugarNacimiento: 'Baracaldo',
    provinciaNacimiento: 'Vizcaya',
    fechaNacimiento: '1989-04-05',
    imagen: 'https://i.ibb.co/TxgH4XWX/Cerrajer-a-PNG.webp',
  },

  'diego-rua-vicente': {
    nombre: 'Diego',
    apellidos: 'Rúa Vicente',
    nombreCompleto: 'Diego Rúa Vicente',
    apodo: 'Diego Rúa',
    posicion: 'Centrocampista',
    posicionCorta: 'MCO',
    altura: 1.74,
    ...
    imagen: 'https://i.ibb.co/sd52sw5F/Diego-R-a-PNG.webp',
  },

  'adrian-llano-mendez': {
    nombre: 'Adrián',
    apellidos: 'Llano Méndez',
    nombreCompleto: 'Adrián Llano Méndez',
    apodo: 'Adrián Llano',
    posicion: 'Centrocampista',
    posicionCorta: 'MC',
    altura: 1.88,
    ...
    imagen: 'https://i.ibb.co/C3Zbwvd1/Adri-n-Llano-PNG.webp',
  },

  'pelayo-novo-garcia': {
    nombre: 'Pelayo',
    apellidos: 'Novo García',
    nombreCompleto: 'Pelayo Novo García',
    apodo: 'Pelayo',
    posicion: 'Centrocampista',
    posicionCorta: 'MC',
    altura: 1.75,
    ...
    imagen: 'https://i.ibb.co/Lddts2G2/Pelayo-PNG.webp',
    fallecido: true,
    fechaFallecimiento: '2023-02-28',
  },

  'paul-abasolo-amantegui': {
    nombre: 'Paul',
    apellidos: 'Abasolo Amantegui',
    nombreCompleto: 'Paul Abasolo Amantegui',
    apodo: 'Abasolo',
    posicion: 'Centrocampista',
    posicionCorta: 'MCO',
    altura: 1.84,
    ...
    imagen: 'https://i.ibb.co/zW3BB9df/Abasolo-PNG.webp',
  },

  'miguel-falcon-garcia-ramos': {
    nombre: 'Miguel',
    apellidos: 'Falcón García-Ramos',
    nombreCompleto: 'Miguel Falcón García-Ramos',
    apodo: 'Falcón',
    posicion: 'Centrocampista',
    posicionCorta: 'MC',
    altura: 1.85,
    ...
    lugarNacimiento: 'Toledo',
    provinciaNacimiento: 'Toledo',
    fechaNacimiento: '1979-04-24',
    imagen: 'https://i.ibb.co/RJBzPnC/Falc-n-PNG.webp',
  },

  'teodoro-jose-tirado-garcia': {
    nombre: 'Teodoro José',
    apellidos: 'Tirado García',
    nombreCompleto: 'Teodoro José Tirado García',
    apodo: 'Teo',
    posicion: 'Centrocampista',
    posicionCorta: 'MCO',
    altura: 1.74,
    ...
    lugarNacimiento: 'Madrid',
    provinciaNacimiento: 'Madrid',
    fechaNacimiento: '1985-07-16',
    imagen: 'https://i.ibb.co/gZ53q6nS/Teo-PNG.webp',
  },

  'mariano-gonzalez-maroto': {
    nombre: 'Mariano',
    apellidos: 'González Maroto',
    nombreCompleto: 'Mariano González Maroto',
    apodo: 'Nano',
    posicion: 'Centrocampista',
    posicionCorta: 'MCD',
    altura: 1.82,
    ...
    lugarNacimiento: 'Málaga',
    provinciaNacimiento: 'Málaga',
    fechaNacimiento: '1984-10-27',
    imagen: 'https://i.ibb.co/SX2J80p4/Nano-PNG.webp',
  },

  'diego-rodriguez-chamorro': {
    nombre: 'Diego',
    apellidos: 'Rodríguez Chamorro',
    nombreCompleto: 'Diego Rodríguez Chamorro',
    apodo: 'Chamorro',
    posicion: 'Centrocampista',
    posicionCorta: 'MCO',
    altura: 1.84,
    ...
    lugarNacimiento: 'Oviedo',
    provinciaNacimiento: 'Asturias',
    fechaNacimiento: '1989-10-30',
    imagen: 'https://i.ibb.co/JRVxrmfP/Chamorro-PNG.webp',
  },

  'david-gonzalez-diaz': {
    nombre: 'David',
    apellidos: 'González Díaz',
    nombreCompleto: 'David González Díaz',
    ...
    imagen: 'https://i.ibb.co/QjDS4ZFt/David-Gonz-lez-PNG.webp',
    seleccion: {
      pais: 'España',
      bandera: 'https://flagcdn.com/16x12/es.webp',
      datos: [
  ...
  'pablo-cesar-espina-ordonez': {
    nombre: 'Pablo César',
    apellidos: 'Espina Ordóñez',
    nombreCompleto: 'Pablo César Espina Ordóñez',
    apodo: 'Pablo Espina',
    posicion: 'Centrocampista',
    posicionCorta: 'MCO',
    altura: 1.84,
  ...
  'xavier-fernandez-annunziata': {
    nombre: 'Xavier',
    apellidos: 'Fernández Annunziata',
    nombreCompleto: 'Xavier Fernández Annunziata',
    apodo: 'Annunziata',
    posicion: 'Delantero',
    posicionCorta: 'EI',
    altura: 1.77,
    ...
    lugarNacimiento: 'Santa Cruz de Tenerife',
    provinciaNacimiento: 'Santa Cruz de Tenerife',
    fechaNacimiento: '1987-08-31',
    imagen: 'https://i.ibb.co/zhrKhtjJ/Annunziata-PNG.webp',
  },

  'manuel-adolfo-busto-loza': {
    nombre: 'Manuel Adolfo',
    apellidos: 'Busto Loza',
    nombreCompleto: 'Manuel Adolfo Busto Loza',
    apodo: 'Manu Busto',
    posicion: 'Delantero',
    posicionCorta: 'ED',
    altura: 1.65,
    ...
    lugarNacimiento: 'Santander',
    provinciaNacimiento: 'Cantabria',
    fechaNacimiento: '1980-10-07',
    imagen: 'https://i.ibb.co/xqd1qsm9/Manu-Busto-PNG.webp',
  },

  'daniel-aquino-pintos': {
    nombre: 'Daniel',
    apellidos: 'Aquino Pintos',
    nombreCompleto: 'Daniel Aquino Pintos',
    apodo: 'Aquino',
    posicion: 'Delantero',
    posicionCorta: 'EI',
    altura: 1.78,
    ...
    imagen: 'https://i.ibb.co/6pMW0Bd/Aquino-PNG.webp',
    seleccion: {
      pais: 'España',
      bandera: 'https://flagcdn.com/16x12/es.webp',
      datos: [
  ...
  'jose-diaz-sanchez': {
    ...
    nombreCompleto: 'José Díaz Sánchez',
    apodo: 'Pepe Díaz',
    posicion: 'Delantero',
    posicionCorta: 'DL',
    altura: 1.73,
    nacionalidad: ['Española'],
    lugarNacimiento: 'Almodóvar del Río',
    provinciaNacimiento: 'Córdoba',
    fechaNacimiento: '1980-04-20',
    imagen: 'https://i.ibb.co/23mz1SnC/Pepe-D-az-PNG.webp',
  },

  'oscar-martinez-cid': {
    nombre: 'Óscar',
    apellidos: 'Martínez Cid',
    nombreCompleto: 'Óscar Martínez Cid',
    apodo: 'Óscar Martínez',
    posicion: 'Delantero',
    posicionCorta: 'DL',
    altura: 1.85,
    nacionalidad: ['Española'],
    lugarNacimiento: 'Orense',
    provinciaNacimiento: 'Orense',
    fechaNacimiento: '1979-03-09',
    imagen: 'https://i.ibb.co/JwwV56tF/scar-Mart-nez-PNG.webp',
  },

  'francisco-sol-ortiz': {
    nombre: 'Francisco',
    apellidos: 'Sol Ortiz',
    nombreCompleto: 'Francisco Sol Ortiz',
    apodo: 'Fran Sol',
    posicion: 'Delantero',
    posicionCorta: 'DL',
    altura: 1.82,
    ...
    lugarNacimiento: 'Madrid',
    provinciaNacimiento: 'Madrid',
    fechaNacimiento: '1992-03-13',
    imagen: 'https://i.ibb.co/yFB2b2ww/Fran-Sol-PNG.webp',
    seleccion: {
      pais: 'España',
      bandera: 'https://flagcdn.com/16x12/es.webp',
      datos: [
  ...
  'alejandro-blanco-gonzalez': {
    nombre: 'Alejandro',
    apellidos: 'Blanco González',
    nombreCompleto: 'Alejandro Blanco González',
    apodo: 'Jandrín',
    posicion: 'Delantero',
    posicionCorta: 'ED',
    altura: 1.7,
    nacionalidad: ['Española'],
    lugarNacimiento: 'Lugones',
    provinciaNacimiento: 'Asturias',
    fechaNacimiento: '1990-08-19',
    imagen: 'https://i.ibb.co/TBCfL5tz/Jandr-n-PNG.webp',
  },

  'jairo-carcaba-gonzalez': {
    nombre: 'Jairo',
    apellidos: 'Cárcaba González',
    nombreCompleto: 'Jairo Cárcaba González',
    apodo: 'Jairo Cárcaba',
    posicion: 'Delantero',
    posicionCorta: 'DL',
    altura: 1.84,
    ...
    lugarNacimiento: 'Gijón',
    provinciaNacimiento: 'Asturias',
    fechaNacimiento: '1992-05-27',
    imagen: 'https://i.ibb.co/rfc23B88/Jairo-C-rcaba-PNG.webp',
  },

  'borja-rubiato-martinez': {
    nombre: 'Borja',
    apellidos: 'Rubiato Martínez',
    nombreCompleto: 'Borja Rubiato Martínez',
    apodo: 'Borja Rubiato',
    posicion: 'Delantero',
    posicionCorta: 'DL',
    altura: 1.85,
    ...
    imagen: 'https://i.ibb.co/HTqt71wp/Borja-Rubiato-PNG.webp',
  },

  'matar-diop-martins': {
    nombre: 'Matar',
    apellidos: 'Diop Martins',
    nombreCompleto: 'Matar Diop Martins',
    apodo: 'Martins',
    posicion: 'Delantero',
    posicionCorta: 'DL',
    altura: 1.83,
...
CLUB_DATA.entrenadorMaestro = {
  ...
  'alvaro-cervera-diaz': {
    ...
    imagen: 'https://i.postimg.cc/dQZzYx5v/Alvaro-Cervera-(entrenador)-PNG.webp',
  },
  ...
  'jose-carlos-granero-granero': {
    nombre: 'José Carlos',
    apellidos: 'Granero Granero',
    nombreCompleto: 'José Carlos Granero Granero',
    apodo: 'José Carlos Granero',
    cargo: 'Entrenador Principal',
    cargoCorto: 'ENT',
    nacionalidad: ['Española'],
    lugarNacimiento: 'Chella',
    provinciaNacimiento: 'Valencia',
    fechaNacimiento: '1963-05-27',
    imagen: 'https://i.ibb.co/v61mZgp5/Granero-entrenador-PNG.webp',
  },

  'roberto-robles-feijoo': {
    nombre: 'Roberto',
    apellidos: 'Robles Feijoo',
    nombreCompleto: 'Roberto Robles Feijoo',
    apodo: 'Roberto Robles',
    cargo: 'Entrenador Principal',
    cargoCorto: 'ENT',
    nacionalidad: ['Española'],
    lugarNacimiento: 'Gijón',
  ...
  'felix-angel-sarriugarte-montoya': {
    nombre: 'Félix Ángel',
    apellidos: 'Sarriugarte Montoya',
    nombreCompleto: 'Félix Ángel Sarriugarte Montoya',
    apodo: 'Félix Sarriugarte',
    cargo: 'Entrenador Principal',
    cargoCorto: 'ENT',
    nacionalidad: ['Española'],
    lugarNacimiento: 'Durango',
    provinciaNacimiento: 'Vizcaya',
    fechaNacimiento: '1964-11-06',
  ...
  'jose-rojo-martin': {
    nombre: 'José',
    apellidos: 'Rojo Martín',
    nombreCompleto: 'José Rojo Martín',
    apodo: 'Pacheta',
    cargo: 'Entrenador Principal',
    cargoCorto: 'ENT',
    nacionalidad: ['Española'],
    lugarNacimiento: 'Salas de los Infantes',
